...
const { historia } = require('./src/historia')
const { menuinterativo } = require('./src/menuinterativo')
...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color('scan the code above'))
	})
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD Rilexxx BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Rilexxx? Este é um recurso especial para o Rilexxx ❌',
					ownerB: '[❗] Rilexxx? Este é um recurso especial para o Rilexxx ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de Rilexxx. Registre-se para fazer amizade com o bot Rilexxx por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Rilexxx|17\n\n──「 RILEXXX BOT 」──`,
			...
			const ownerNumber = ["557988312466@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"557988312466@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["557988312466@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["557988312466@s.whatsapp.net"]//ubah nomor lo
			const premium = ["557988312466@s.whatsapp.net","557988155575@s.whatsapp.net"] 
...
//@darkYT					
    ...
    break
				...
				case 'textblue':
					...
					break
					case 'historia':
					client.sendMessage(from, historia(prefix) , text, { quoted: mek })
					break
					case 'outros':
					...
					break
					case 'menuinterativo':
					client.sendMessage(from, menuinterativo(prefix) , text, { quoted: mek })
					break
				case 'textsky':
					if (args.length < 1) return reply(mess.blank)
					tels = body.slice(9)
...
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'lojas_guanabara':
tujuh = fs.readFileSync('./assets/sound.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'ola':
...
break
case 'beat3':
tujuh = fs.readFileSync('./assets/beat3.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat4':
tujuh = fs.readFileSync('./assets/beat4.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat5':
tujuh = fs.readFileSync('./assets/beat5.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'xxx1':
...
break
case 'shit4':
tujuh = fs.readFileSync('./assets/shit4.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit5':
tujuh = fs.readFileSync('./assets/shit5.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit6':
tujuh = fs.readFileSync('./assets/shit6.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit7':
tujuh = fs.readFileSync('./assets/shit7.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit8':
tujuh = fs.readFileSync('./assets/shit8.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit9':
tujuh = fs.readFileSync('./assets/shit9.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit10':
tujuh = fs.readFileSync('./assets/shit10.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit11':
tujuh = fs.readFileSync('./assets/shit11.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit12':
tujuh = fs.readFileSync('./assets/shit12.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit13':
tujuh = fs.readFileSync('./assets/shit13.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit14':
tujuh = fs.readFileSync('./assets/shit14.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit15':
tujuh = fs.readFileSync('./assets/shit15.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit16':
tujuh = fs.readFileSync('./assets/shit16.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit17':
tujuh = fs.readFileSync('./assets/shit17.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit18':
tujuh = fs.readFileSync('./assets/shit18.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit19':
tujuh = fs.readFileSync('./assets/shit19.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit20':
tujuh = fs.readFileSync('./assets/shit20.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit21':
tujuh = fs.readFileSync('./assets/shit21.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit22':
tujuh = fs.readFileSync('./assets/shit22.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit23':
tujuh = fs.readFileSync('./assets/shit23.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit24':
tujuh = fs.readFileSync('./assets/shit24.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit25':
tujuh = fs.readFileSync('./assets/shit25.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit26':
tujuh = fs.readFileSync('./assets/shit26.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit27':
tujuh = fs.readFileSync('./assets/shit27.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit28':
tujuh = fs.readFileSync('./assets/shit28.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit29':
tujuh = fs.readFileSync('./assets/shit29.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit30':
tujuh = fs.readFileSync('./assets/shit30.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'm4':
...
break
case 'xxt1':
tujuh = fs.readFileSync('./assets/xxxt1.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'xxt2':
tujuh = fs.readFileSync('./assets/xxxt2.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'xxt3':
tujuh = fs.readFileSync('./assets/xxxt3.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap1':
...
break
case 'matue':
tujuh = fs.readFileSync('./assets/matue.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'plutao':
tujuh = fs.readFileSync('./assets/plutao.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'diazul':
tujuh = fs.readFileSync('./assets/teto.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'nois2pelado':
tujuh = fs.readFileSync('./assets/nois2pel.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'nyapasu':
tujuh = fs.readFileSync('./assets/nyapasu.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sexo':
tujuh = fs.readFileSync('./assets/sexo.mp3');
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS RILEXXX BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @RILEXXX domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o RILEXXX ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT RILEXXX ✨* 」\n*│+ wa.me/5547992091566*╰──────*「 *RILEXXX* 」*────*\n\n*_SE QUER SER ADMIN DO BOT RILEXXX_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/554792091566/*╰──────*「 * RILEXXX* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO RILEXXX BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do RILEXXX:*\n\n https://youtube.com/channel/UCcnNtbIsBs6mIkgxKuF1IAw'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/01GPQG0`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* RILEXXX\n*YOUTUBE:* https://youtube.com/channel/UCcnNtbIsBs6mIkgxKuF1IAw\n*WPP:* wa.me/+557988312466\n*INSTA:* https://www.instagram.com/rilexx_shit/\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
